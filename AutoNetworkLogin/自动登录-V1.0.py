...
class NetworkLoginApp(QMainWindow):
    ...
    def create_default_config(self):
        ...
        default_config = {
            'Login': {
                ...
                'opr': 'pwdLogin',
                'userName': '徐英珺',
                'pwd': '2517075623deb2a7',
                'auth_tag': '1762421153496',
                'rememberPwd': '0'
            },
            'Headers': {
                'Accept': '*/*',
                ...
                'Cookie': 'Sessionid=3814964548-1',
                'DNT': '1',
                'Host': '1.1.1.3',
                'Origin': 'http://1.1.1.3',
                'Pragma': 'no-cache',
                'Referer': 'http://1.1.1.3/ac_portal/default/pc.html?template=default&tabs=pwd&vlanid=0&_ID_=0&switch_url=&url=http://1.1.1.3/homepage/index.html&controller_type=&mac=00-00-00-00-00-00',
    ...
    def init_ui(self):
        ...
        info_layout.addWidget(QLabel(f"用户: {self.config['Login']['userName']}"))
